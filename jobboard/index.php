...
$select = "SELECT * FROM jobs WHERE status = 1 ORDER BY created_at DESC LIMIT 5 ";
$sel = mysqli_query($conn , $select);
$jobs = mysqli_fetch_assoc($sel);


$searches_trending = "SELECT COUNT(keyword) AS count  , keyword FROM searches
            GROUP BY keyword ORDER BY count DESC LIMIT 5";
$searches = mysqli_query($conn ,$searches_trending);
$allsearches = mysqli_fetch_assoc($searches);
    ...
    <ul class="job-listings mb-5">
      ...
      <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
        ...
        <div class="job-listing-logo">
          <img src="users/user-images/<?php $job['company_image'];?>" alt="<?php $job['company_image'];?>" class="img-fluid">
        </div>

        <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
          <div class="job-listing-position custom-width w-50 mb-3 mb-sm-0">
            <h2><?php $job['job_title'];?></h2>
            <strong><?php $job['company_name'];?></strong>
          </div>
          <div class="job-listing-location mb-3 mb-sm-0 custom-width w-25">
            <span class="icon-room"></span> <?php $job['job_region'];?>
          </div>
