...
<?php 
  ...
  $get_catgories = "SELECT * FROM categories";
 $get_category =  mysqli_query($conn , $get_catgories);
  $category = mysqli_fetch_assoc($get_category);
    ...
    if(isset($_POST['submit'])) {
      ...
      OR empty($_POST['education_experience']) OR empty($_POST['job_category']) OR empty($_POST['other_benifits']) OR empty($_POST['company_email']) OR empty($_POST['company_name']) OR empty($_POST['company_id']) OR empty($_POST['company_image']) 
      ) {
